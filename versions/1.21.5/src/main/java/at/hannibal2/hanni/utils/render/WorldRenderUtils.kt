...
import at.hannibal2.hanni.features.misc.PatcherFixes
...
import at.hannibal2.hanni.utils.compat.deceased
...
object WorldRenderUtils {
    ...
    fun HanniRenderWorldEvent.drawFilledBoundingBox(
        ...
        val layer = HanniRenderLayers.getFilled(seeThroughBlocks)
    ...
    fun HanniRenderWorldEvent.drawCircleFilled(
        ...
        val layer = HanniRenderLayers.getTriangleFan(!depth)
        val buf = vertexConsumers.getBuffer(layer)
        matrices.push()
    ...
    fun HanniRenderWorldEvent.drawCylinderInWorld(
        ...
        val layer = HanniRenderLayers.getFilled(false)
        val buf = vertexConsumers.getBuffer(layer)
        matrices.push()
    ...
    fun HanniRenderWorldEvent.drawPyramid(
        ...
        val layer = HanniRenderLayers.getTriangles(!depth)
        val buf = vertexConsumers.getBuffer(layer)
        matrices.push()
    ...
    // TODO add chroma color support
    fun HanniRenderWorldEvent.drawEdges(axisAlignedBB: Box, color: Color, lineWidth: Int, depth: Boolean) {
        LineDrawer.draw3D(this, lineWidth, depth) {
    ...
    fun HanniRenderWorldEvent.exactBoundingBox(entity: Entity): Box {
