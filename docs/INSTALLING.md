# Download and Install Hanni

Hanni is a Forge mod for **Minecraft 1.8.9 only**.
Running Hanni on Badlion, Lunar, Feather, or newer versions of Minecraft is **not supported**.

Follow this guide to install Hanni in regular Minecraft Forge.
...
> **4: Download NEU**
> NEU is NotEnoughUpdates, another Forge mod that contains files that Hanni depends on to function.
...
> -   [Hanni Discord](https://discord.com/invite/hanni-997079228510117908) in the channel #neu-updates.

> **5: Download Hanni**
> Hanni has two different update circles: [Full Release](https://github.com/hannibal002/Hanni/releases/latest) and [Beta](https://github.com/hannibal002/Hanni/releases).
...
> **6: Find .minecraft**
> Once you have downloaded both NEU and Hanni, you need to navigate to your `.minecraft` folder.
>
...
> Move the NEU and Hanni files you downloaded into the folder.
> Remove older versions of NEU or Hanni in that folder before adding the new files.
> _Note: If you encounter a problem, support may ask for a screenshot of your mods folder: this is the folder you just set up._
...
> **10: Recommended additional mods (optional)** > [OptiFine](https://optifine.net/adloadx?f=preview_OptiFine_1.8.9_HD_U_M6_pre2.jar) and either [Sk1erLLC's Patcher](https://sk1er.club/mods/patcher) or [Polyfrost's PolyPatcher](https://modrinth.com/mod/patcher) (a fork of Patcher with OneConfig, slightly different features, and bug fixes, including fixed cactus hitboxes).
> Those two mods help you get more FPS in-game and let you change many more performance settings.

_Ask in #support if you need help with a step during installation.
If you have any other questions about the mod, please read our #faq before asking in #support for help._
...
_This guide was last updated on December 24th, 2024._
