...
+ Added Improved SB Menus from NEU. - Daveed (https://github.com/hannibal002/SkyHanni/pull/4270)
    + Functionality should be a near, if not perfect match.
    + Can only be used on modern Minecraft versions.
