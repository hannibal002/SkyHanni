# Hanni - List of all Features

Use `/sh` or `/hanni` to open the Hanni config in game.
...
-   Bits Gained Chat Message. - j10a1n15 (https://github.com/hannibal002/Hanni/pull/1487)
-   Option to reorder or hide every part of a player chat message. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1483)
...
-   Hide Level Brackets. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1483)
    -   Hide the gray brackets in front of and behind the level numbers.
-   Level Color As Name. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1483)
...
*   More chat filters. - Mikecraft1224 (https://github.com/hannibal002/Hanni/pull/1750)
...
-   Croesus Limit Warning. - saga (https://github.com/hannibal002/Hanni/pull/1908)
...
-   SA Jump Notification. - CarsCupcake (https://github.com/hannibal002/Hanni/pull/852)
    -   Warn shorty before a Shadow Assassin jumps to you in dungeons.
-   Notifications for architect on puzzle fail. - Conutik (https://github.com/hannibal002/Hanni/pull/1197)
    -   Shows Title.
    -   Shows button in chat to retrieve from sack.
    -   Only works when having enough Architect First Drafts in the sack.
-   Dungeon hub race waypoints. - seraid (https://github.com/hannibal002/Hanni/pull/1471)
    -   Only works for Nothing; No return races.
-   Added the ability to hide solo class, solo class stats and fairy dialogue chat messages in Dungeons. - raven (https://github.com/hannibal002/Hanni/pull/1702)
...
-   Option in the Auction House search browser to search for the item on coflnet.com. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1743)
...
-   AH Show Price Comparison. - hannibal2 (https://github.com/hannibal002/Hanni/pull/339)
...
-   Highlight options in /tab. - Conutik (https://github.com/hannibal002/Hanni/pull/1175)
    -   Green for enabled
    -   Red for disabled
-   SBA style Enchant Parsing. - Vixid (https://github.com/hannibal002/Hanni/pull/654)
...
-   Favorite Power Stones. - saga (https://github.com/hannibal002/Hanni/pull/2002)
...
-   Item Pickup Log. - catgirlseraid (https://github.com/hannibal002/Hanni/pull/1937)
...
-   Craft Materials From Bazaar. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1104)
...
-   Totem Overlay. - j10a1n15 (https://github.com/hannibal002/Hanni/pull/1139)
...
-   Trophy Fishing Display. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1754)
...
-   Customizable Inquisitor Highlight color. - Empa (https://github.com/hannibal002/Hanni/pull/1323)
-   Mobs since last Inquisitor to Mythological Creature Tracker. - CuzImClicks (https://github.com/hannibal002/Hanni/pull/1346)
-   Blaze Slayer fire pillar display. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1766)
...
-   "Line to Arachne" setting, just like with slayer mini bosses. - azurejelly (https://github.com/hannibal002/Hanni/pull/1888)
...
-   Crop last farmed waypoint. - appable (https://github.com/hannibal002/Hanni/pull/1335)
...
-   Made Rancher's Boots the stack size display account for the Cactus Knife now giving +100 speed cap while in the Garden. - Alexia Luna (https://github.com/hannibal002/Hanni/pull/1149)
...
-   Plot Menu Highlighting - ILike2WatchMemes (https://github.com/hannibal002/Hanni/pull/1181)
    -   Plot highlighting based on plot statuses (pests, active spray, current plot, locked plot)
-   Pest Waypoint. - Empa + hannibal2 + Thunderblade73 (https://github.com/hannibal002/Hanni/pull/1268)
...
-   Pest Profit Tracker. - Empa (https://github.com/hannibal002/Hanni/pull/1321)
-   Open On Elite. - Obsidian (https://github.com/hannibal002/Hanni/pull/1185)
...
-   Visitor's Logbook Stats. - HiZe (https://github.com/hannibal002/Hanni/pull/1287)
    -   Show all your visited/accepted/denied visitors stats in a display.
-   Stereo Harmony Display. - Empa (https://github.com/hannibal002/Hanni/pull/1324)
...
-   Overflow Garden crop milestones. - Luna & HiZe (https://github.com/hannibal002/Hanni/pull/997)
-   New "Craftable!" message when Visitor Items Needed are craftable. - Paloys (https://github.com/hannibal002/Hanni/pull/1891)
...
-   Vermin Highlight. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1457)
...
-   Area Walls. - Thunderblade73 (https://github.com/hannibal002/Hanni/pull/1266)
...
-   Excavation Profit Tracker. - hannibal2 + Empa (https://github.com/hannibal002/Hanni/pull/1432)
...
-   Mining Notifications. - martimavocado (https://github.com/hannibal002/Hanni/pull/1429)
    -   Mining events, including Mineshaft spawning, Suspicious Scrap drops, and Cold going above a threshold.
-   Configurable cold amount for the ascension rope message in Glacite Mines. - nopo (https://github.com/hannibal002/Hanni/pull/1905)
-   Profit Per Excavation. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1439)
    -   Show profit/loss in chat after each excavation.
    -   Also include breakdown information on hover.
-   Textured cold overlay to Glacite Tunnels. - j10a1n15, Empa (https://github.com/hannibal002/Hanni/pull/1438)
    -   Change at what cold level the texture should appear.
-   Glacial Powder as stack size in the Fossil Excavator. - jani270 (https://github.com/hannibal002/Hanni/pull/1458)
-   Highlight own Golden/Diamond Goblin. - Thunderblade73 (https://github.com/hannibal002/Hanni/pull/1466)
-   Click to get an Ascension Rope from sacks in the Mineshaft. - j10a1n15 (https://github.com/hannibal002/Hanni/pull/1542)
-   Tunnel Maps. - Thunderblade73 (https://github.com/hannibal002/Hanni/pull/1546)
    -   Provides a way to navigate inside the new Glacite Tunnels.
-   Commissions Blocks Color. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1701)
...
-   HOTM perks level and Enable Display. - Thunderblade73 (https://github.com/hannibal002/Hanni/pull/1059)
-   Mineshaft Corpse and Entrance/Ladder Locators. - nobaboy (https://github.com/hannibal002/Hanni/pull/1500)
    -   Includes keybind functionality for both.
-   HotM Perks Powder features. - j10a1n15 (https://github.com/hannibal002/Hanni/pull/1460)
    -   Added total powder cost to HotM perks.
    -   Added powder cost for 10 levels.
-   Mineshaft Pity Display. - Empa (https://github.com/hannibal002/Hanni/pull/1655)
...
-   Added HotF Lottery display. - Daveed (https://github.com/hannibal002/Hanni/pull/4332)
...
-   Option to show time held in lore for Jyrre Bottles and Cacao Truffles. - Obsidian (https://github.com/hannibal002/Hanni/pull/1916)
...
-   Hoppity rabbit collection stats summary. - CalMWolfs (https://github.com/hannibal002/Hanni/pull/1482)
-   Stuff for Chocolate Factory. - CalMWolfs (https://github.com/hannibal002/Hanni/pull/1434)
...
-   Chocolate Factory Menu Shortcut (Hoppity Menu Shortcut). - raven + martimavocado (https://github.com/hannibal002/Hanni/pull/1583)
-   Tooltip Move. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1581)
    -   Moves the tooltip away from the item you hover over while inside the Chocolate Factory.
-   Chocolate Factory Compact On Click. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1579)
-   Factory Chat Filters. - RobotHanzo (https://github.com/hannibal002/Hanni/pull/1574)
...
-   Added time tower status to the chocolate factory stats. - CalMWolfs (https://github.com/hannibal002/Hanni/pull/1506)
    -   Also can notify you when you get a new charge or your charges are full.
-   Extra tooltip stats about upgrades for the chocolate factory. - CalMWolfs (https://github.com/hannibal002/Hanni/pull/1594)
    -   View these to know when to buy time tower or Coach Jackrabbit.
-   Chocolate Leaderboard Change. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1602)
...
-   Chocolate Shop Price. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1601)
    -   Show chocolate to coin prices inside the Chocolate Shop inventory.
-   Keybinds for Chocolate Factory. - seraid (https://github.com/hannibal002/Hanni/pull/1644)
-   Warning when Chocolate Factory upgrade is available. - seraid (https://github.com/hannibal002/Hanni/pull/1642)
-   Amount of chocolate until next prestige to stats display. - seraid (https://github.com/hannibal002/Hanni/pull/1638)
-   Ability to adjust the opacity of players near shared and guessed egg waypoints. - RobotHanzo (https://github.com/hannibal002/Hanni/pull/1582)
-   Time until the next Hoppity event in chat message for egg locator. - seraid (https://github.com/hannibal002/Hanni/pull/1625)
-   Warning before the Time Tower in the Chocolate Factory ends. - seraid (https://github.com/hannibal002/Hanni/pull/1816)
-   Chat reminder to check Hoppity Shop each year. - appable (https://github.com/hannibal002/Hanni/pull/1843)
-   Highlight rabbits that have requirements in the Hoppity's Collection menu. - HiZe (https://github.com/hannibal002/Hanni/pull/1874)
    -   Green: Requirement met.
    -   Red: Requirement not met.
-   Mark duplicate egg locations in red for unlocking some of the new rabbits. - appable (https://github.com/hannibal002/Hanni/pull/1929)
    -   Option to always mark nearby duplicate egg locations.
-   Mark duplicate egg locations in red for unlocking some of the new rabbits. - appable (https://github.com/hannibal002/Hanni/pull/1929)
    -   Option to always mark nearby duplicate egg locations.
-   Show total amount of chocolate spent in the Chocolate Shop. - sayomaki (https://github.com/hannibal002/Hanni/pull/1921)
-   Stray/golden chocolate rabbit production time. - sayomaki (https://github.com/hannibal002/Hanni/pull/1978)
...
-   Rabbit Pet Warning. - hannibal2 (https://github.com/hannibal002/Hanni/pull/2087)
...
-   Added Century Daily Task Highlight. - Thunderbalde73 (https://github.com/hannibal002/Hanni/pull/3355)
...
-   /shupdate command. - Empa (https://github.com/hannibal002/Hanni/pull/1578)
    -   Can be used like `/shupdate <beta/full>` to download updates from a specific update stream.
-   /shignore. - martimavocado (https://github.com/hannibal002/Hanni/pull/1469)
...
-   Matriarch Helper. - Thunderblade73 (https://github.com/hannibal002/Hanni/pull/1385)
...
-   **Discord RPC** - NetheriteMiner
    ...
    -   SkyCrypt Button. - ThatGravyBoat (https://github.com/hannibal002/Hanni/pull/1526)
...
-   Dark Cacao Truffle hours held as stack size. - Obsidian (https://github.com/hannibal002/Hanni/pull/1916)
...
-   **Hanni Installer** - NetheriteMiner
...
-   Skill Progress Display. - HiZe
    ...
    -   A ton of settings.
-   Command `/shlimbo` for easier Limbo access. - martimavocado (https://github.com/hannibal002/Hanni/pull/848)
...
-   Click on breakdown display in /playtimedetailed to copy the stats into the clipboard. - seraid (https://github.com/hannibal002/Hanni/pull/1807)
-   Custom Scoreboard - j10a1n15 (https://github.com/hannibal002/Hanni/pull/893)
...
-   No Bits Available Warning. - Empa (https://github.com/hannibal002/Hanni/pull/1286)
...
-   Link from HUD elements to config options. - nea (https://github.com/hannibal002/Hanni/pull/1383)
...
-   Quiver Display. - Empa (https://github.com/hannibal002/Hanni/pull/1190)
    -   Only shows the type of arrow when wearing a Skeleton Master Chestplate.
-   Low Quiver Reminder at the end of Dungeon/Kuudra run. - Empa (https://github.com/hannibal002/Hanni/pull/1190)
-   party chat commands. - nea (https://github.com/hannibal002/Hanni/pull/1433)
...
-   Option to highlight Zealots holding Chests in a different color. - Luna (https://github.com/hannibal002/Hanni/pull/1347)
-   Allow party members to request allinvite to be turned on. - CalMWolfs (https://github.com/hannibal002/Hanni/pull/1464)
...
-   Inventory background to GUI editor. - seraid (https://github.com/hannibal002/Hanni/pull/1622)
...
-   Simple Ferocity Display. - hannibal2 (https://github.com/hannibal002/Hanni/pull/1765)
...
-   Editable Hotbar. - Thunderblade73 (https://github.com/hannibal002/Hanni/pull/1903)
    -   Allows for moving and scaling in the Hanni GUI editor.
-   ULTRA RARE Book Notification when doing the Experiment Table. - raven (https://github.com/hannibal002/Hanni/pull/1738)
...
-   In-Water Display. - Stella (https://github.com/hannibal002/Hanni/pull/1892)
...
-   **Custom Wardrobe**, a new look for the wardrobe. - j10an15, Empa (https://github.com/hannibal002/Hanni/pull/2039)
    -   Highly customizable: Colors, display sizes.
    -   Estimated Price Integration.
    -   Favorite slots; option to only display favorite slots.
-   Added a Chat Message if the Perkpocalypse Mayor is unknown. - j10a1n15 (https://github.com/hannibal002/Hanni/pull/2009)
...
-   Added option to display Skyblock XP on the Minecraft XP bar. - j10a1n1 (https://github.com/hannibal002/Hanni/pull/2886)
...
-   Added Bouncy Beach Balls features. - Thunderblade + hannibal2 (https://github.com/hannibal002/Hanni/pull/3432)
