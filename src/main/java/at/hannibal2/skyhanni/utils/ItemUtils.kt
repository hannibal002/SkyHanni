...
object ItemUtils {
    ...
    private val internalNameCache = TimeLimitedCache<IdentityCharacteristics<ItemStack>, NeuInternalName>(
    ...
    fun ItemStack.getLoreComponent(): List<Component> = components.getLoreComponent()
    ...
    fun ItemStack.getInternalName(): NeuInternalName =
