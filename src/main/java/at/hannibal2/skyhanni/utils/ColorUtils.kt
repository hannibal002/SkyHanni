...
object ColorUtils {
    ...
    fun blendRGB(start: Color, end: Color, percent: Double): Color = Color(
    ...
    fun blendRGB(start: LorenzColor, end: LorenzColor, percent: Double): Color = Color(
    ...
    fun Color.darker(factor: Double = 0.7): Color = Color(
