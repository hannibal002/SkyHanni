...
object StringUtils {
    ...
    fun String.pluralize(number: Number) = pluralize(number, this)

    fun pluralize(number: Number, singular: String, plural: String? = null, withNumber: Boolean = false): String {
