...
open class CircularRenderable(
    ...
    override fun render(mousePosX: Int, mousePosY: Int) = when {
...
class CircularContainerRenderable(
    ...
    override fun render(mousePosX: Int, mousePosY: Int) {
        super.render(mousePosX, mousePosY)
        DrawContextUtils.translated(padding.toFloat(), padding.toFloat(), 0f) {
            renderable.renderXYAligned(mousePosX + padding, mousePosY + padding, takenSpace, takenSpace)
        }
    }
}
