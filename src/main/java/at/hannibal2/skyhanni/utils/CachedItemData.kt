...
data class CachedItemData(
    ...
    companion object {
        private val cache = TimeLimitedCache<IdentityCharacteristics<SafeItemStack>, CachedItemData>(expireAfterWrite = 2.minutes)
        val SafeItemStack.cachedData: CachedItemData
