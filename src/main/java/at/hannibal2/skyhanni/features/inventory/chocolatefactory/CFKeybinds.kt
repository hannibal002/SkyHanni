package at.hannibal2.skyhanni.features.inventory.chocolatefactory import at.hannibal2.skyhanni.utils.compat.container
...
object CFKeybinds {
    ...
    fun onKeyPress(event: GuiKeyPressEvent) {
        ...
        for (index in 0..6) {
            ...
            InventoryUtils.clickSlot(28 + index, chest.container.syncId, mouseButton = 2, mode = 3)
            break
        }
    }
