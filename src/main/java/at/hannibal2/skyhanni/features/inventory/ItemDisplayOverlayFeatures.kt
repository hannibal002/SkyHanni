...
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry.COLLECTION_LEVEL
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry.DUNGEON_HEAD_FLOOR_NUMBER
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry.DUNGEON_POTION_LEVEL
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry.KUUDRA_KEY
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry.LARVA_HOOK
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry.MASTER_SKULL_TIER
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry.MASTER_STAR_TIER
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry.MINION_TIER
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry.NEW_YEAR_CAKE
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry.PET_LEVEL
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry.RANCHERS_BOOTS_SPEED
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry.SKILL_LEVEL
import at.hannibal2.skyhanni.config.features.inventory.ItemNumberEntry.VACUUM_GARDEN
