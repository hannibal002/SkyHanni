...
class DungeonCopilot {
    ...
    fun onConfigFix(event: ConfigUpdaterMigrator.ConfigFixEvent){
        event.move(4, "dungeon.messageFilterKeysAndDoors", "dungeon.messageFilter.keysAndDoors")
        event.move(4,"dungeon.copilotEnabled", "dungeon.dungeonCopilot.enabled")
        event.move(4,"dungeon.copilotPos", "dungeon.dungeonCopilot.pos")
    }
}