...
class CactusPage: FFGuideGUI.FFGuidePage() {
    ...
    override fun drawPage(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        if (FFGuideGUI.breakdownMode) {
            textLinesWithTooltip[Pair("§6Cactus Farming Fortune", "")] = Pair(FFGuideGUI.guiLeft + 140,  FFGuideGUI.guiTop + 5)
            textLinesWithTooltip[Pair("§2$del / 1568☘   $del%", "")] = Pair(FFGuideGUI.guiLeft + 140,  FFGuideGUI.guiTop + 15)
            ...
            textLinesWithTooltip[Pair("§2$del / 75☘      $del%", "")] = Pair(FFGuideGUI.guiLeft + 245,  FFGuideGUI.guiTop + 10)
            ...
            textLinesWithTooltip[Pair("§2Turbo-Cacti Enchantment", "§7§2Fortune for each enchantment level\n" +
