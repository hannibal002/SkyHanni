...
object CropMoneyDisplay {
    ...
    fun onConfigFix(event: ConfigUpdaterMigrator.ConfigFixEvent){
        event.move(4, "garden.moneyPerHourDisplay", "garden.moneyPerHour.display")
        event.move(4, "garden.moneyPerHourShowOnlyBest", "garden.moneyPerHour.showOnlyBest")
        event.move(4, "garden.moneyPerHourShowCurrent", "garden.moneyPerHour.showCurrent")
        event.move(4, "garden.moneyPerHourAlwaysOn", "garden.moneyPerHour.alwaysOn")
        event.move(4, "garden.moneyPerHourCompact", "garden.moneyPerHour.compact")
        event.move(4, "garden.moneyPerHourCompactPrice", "garden.moneyPerHour.compactPrice")
        event.move(4, "garden.moneyPerHourUseCustomFormat", "garden.moneyPerHour.useCustomFormat")
        event.move(4, "garden.moneyPerHourCustomFormat", "garden.moneyPerHour.customFormat")
        event.move(4, "garden.moneyPerHourMergeSeeds", "garden.moneyPerHour.mergeSeeds")
        event.move(4, "garden.moneyPerHourBountiful", "garden.moneyPerHour.bountiful")
        event.move(4, "garden.moneyPerHourMooshroom", "garden.moneyPerHour.mooshroom")
        event.move(4, "garden.moneyPerHourArmor", "garden.moneyPerHour.armor")
        event.move(4, "garden.moneyPerHourDicer", "garden.moneyPerHour.dicer")
        event.move(4, "garden.moneyPerHourHideTitle", "garden.moneyPerHour.hideTitle")
        event.move(4, "garden.moneyPerHourPos", "garden.moneyPerHour.pos")
    }
}
