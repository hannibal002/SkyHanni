...
class CanePage: FFGuideGUI.FFGuidePage() {
    ...
    override fun drawPage(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        if (FFGuideGUI.breakdownMode) {
            textLinesWithTooltip[Pair("§6Sugar Cane Farming Fortune", "")] = Pair(FFGuideGUI.guiLeft + 140,  FFGuideGUI.guiTop + 5)
            ...
            textLinesWithTooltip[Pair("§2Turbo-Cane Enchantment", "§7§2Fortune for each enchantment level\n" +
