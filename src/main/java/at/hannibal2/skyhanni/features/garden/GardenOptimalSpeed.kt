...
class GardenOptimalSpeed {
    ...
    fun onConfigFix(event: ConfigUpdaterMigrator.ConfigFixEvent){
        event.move(4,"garden.optimalSpeedEnabled", "garden.optimalSpeed.enabled")
        event.move(4,"garden.optimalSpeedWarning", "garden.optimalSpeed.warning")
        event.move(4,"garden.optimalSpeedSignEnabled", "garden.optimalSpeed.signEnabled")
        event.move(4,"garden.optimalSpeedSignPosition", "garden.optimalSpeed.signPosition")
        event.move(4,"garden.optimalSpeedPos", "garden.optimalSpeed.pos")
        event.move(4,"garden.optimalSpeedCustom.wheat", "garden.optimalSpeed.customSpeed.wheat")
        event.move(4,"garden.optimalSpeedCustom.carrot", "garden.optimalSpeed.customSpeed.carrot")
        event.move(4,"garden.optimalSpeedCustom.potato", "garden.optimalSpeed.customSpeed.potato")
        event.move(4,"garden.optimalSpeedCustom.netherWart", "garden.optimalSpeed.customSpeed.netherWart")
        event.move(4,"garden.optimalSpeedCustom.pumpkin", "garden.optimalSpeed.customSpeed.pumpkin")
        event.move(4,"garden.optimalSpeedCustom.melon", "garden.optimalSpeed.customSpeed.melon")
        event.move(4,"garden.optimalSpeedCustom.cocoaBeans", "garden.optimalSpeed.customSpeed.cocoaBeans")
        event.move(4,"garden.optimalSpeedCustom.sugarCane", "garden.optimalSpeed.customSpeed.sugarCane")
        event.move(4,"garden.optimalSpeedCustom.cactus", "garden.optimalSpeed.customSpeed.cactus")
        event.move(4,"garden.optimalSpeedCustom.mushroom", "garden.optimalSpeed.customSpeed.mushroom")
    }
}