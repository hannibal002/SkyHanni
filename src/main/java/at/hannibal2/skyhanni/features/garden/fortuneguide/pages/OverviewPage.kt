...
class OverviewPage(sizeX: Int, sizeY: Int, paddingX: Int = 15, paddingY: Int = 7, footerSpacing: Int = 6) :
    ...
    fun getPage(): Pair<List<List<Renderable>>, List<Renderable>> {
        ...
        content.addTable(
            1,
            FFInfos.ANITA_BUFF.bar("§2Anita Buff", line)
        )
        ...
        content.addTable(
            2,
            FFInfos.FARMING_LEVEL.bar("§2Farming Level", line)
        )
        ...
        content.addTable(
            3,
            FFInfos.COMMUNITY_SHOP.bar("§2Community upgrades", line)
        )
        ...
        content.addTable(
            4,
            FFInfos.GARDEN_PLOTS.bar("§2Garden Plots", line)
        )
        ...
        content.addTable(
            5,
            FFInfos.CAKE_BUFF.bar("§2Cake Buff", line)
        )
        ...
        content.addTable(
            1,
            FFInfos.TOTAL_ARMOR.bar("§2Total $wordArmor Fortune", line)
        )
        ...
        content.addTable(
            2,
            FFInfos.BASE_ARMOR.bar("§2Base $wordArmor Fortune", line)
        )
        ...
        content.addTable(
            3,
            FFInfos.ABILITY_ARMOR.bar("§2$wordArmor Ability", line)
        )
        ...
        content.addTable(
            4,
            FFInfos.REFORGE_ARMOR.bar("§2$wordArmor Reforge", line)
        )
        ...
        footer.add(
            FFInfos.PET_ITEM.bar("§2Pet Item", line)
        )
        ...
        content.addTable(
            1,
            FFInfos.TOTAL_EQUIP.bar("§2Total $wordEquip Fortune", line)
        )
        ...
        content.addTable(
            2,
            FFInfos.BASE_EQUIP.bar("§2$wordEquip Base Fortune", line)
        )
        ...
        content.addTable(
            3,
            FFInfos.ABILITY_EQUIP.bar("§2$wordEquip Ability", line)
        )
        ...
        content.addTable(
            4,
            FFInfos.REFORGE_EQUIP.bar("§2$wordEquip Reforge", line)
        )
        ...
        content.addTable(
            5,
            FFInfos.ENCHANT_EQUIP.bar("§2$wordEquip Enchantment", line)
        )
