package at.hannibal2.skyhanni.features.garden.pests import at.hannibal2.skyhanni.utils.compat.formattedTextCompat
...
object PestApi {
    ...
    fun isNearPestTrap() = EntityUtils.getAllEntities().filterIsInstance<ArmorStandEntity>().any {
        it.distanceToPlayer() < 10 && pestTrapPattern.matches(it.displayName.formattedTextCompat())
    }
