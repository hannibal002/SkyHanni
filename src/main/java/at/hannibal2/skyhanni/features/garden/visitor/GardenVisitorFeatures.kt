...
object GardenVisitorFeatures {
    ...
    fun onConfigFix(event: ConfigUpdaterMigrator.ConfigFixEvent) {
        ...
        event.move(90, "garden.visitors.shoppingList.display", "garden.visitors.shoppingList.enabled")
        event.move(90, "garden.visitors.shoppingList.pos", "garden.visitors.shoppingList.position")
    }
}
