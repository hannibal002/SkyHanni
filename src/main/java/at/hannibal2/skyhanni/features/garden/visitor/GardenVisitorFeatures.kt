...
object GardenVisitorFeatures {
    ...
    fun onConfigFix(event: ConfigUpdaterMigrator.ConfigFixEvent) {
        ...
        event.move(85, "garden.visitors.shoppingList.display", "garden.visitors.shoppingList.enabled")
        event.move(85, "garden.visitors.shoppingList.pos", "garden.visitors.shoppingList.position")
    }
}
