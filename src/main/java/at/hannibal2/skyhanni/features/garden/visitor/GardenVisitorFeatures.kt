...
class GardenVisitorFeatures {
    ...
    fun onConfigFix(event: ConfigUpdaterMigrator.ConfigFixEvent) {
        event.move(4, "garden.visitorNeedsDisplay", "garden.visitor.needs.display")
        event.move(4, "garden.visitorNeedsPos", "garden.visitor.needs.pos")
        event.move(4, "garden.visitorNeedsOnlyWhenClose", "garden.visitor.needs.onlyWhenClose")
        event.move(4, "garden.visitorNeedsInBazaarAlley", "garden.visitor.needs.inBazaarAlley")
        event.move(4,"garden.visitorNeedsShowPrice", "garden.visitor.needs.showPrice")
        event.move(4,"garden.visitorItemPreview", "garden.visitor.needs.itemPreview")
        event.move(4, "garden.visitorShowPrice", "garden.visitor.inventory.showPrice")
        event.move(4, "garden.visitorExactAmountAndTime", "garden.visitor.inventory.exactAmountAndTime")
        event.move(4, "garden.visitorCopperPrice", "garden.visitor.inventory.copperPrice")
        event.move(4, "garden.visitorCopperTime", "garden.visitor.inventory.copperTime")
        event.move(4, "garden.visitorExperiencePrice", "garden.visitor.inventory.experiencePrice")
        event.move(4,"garden.visitorRewardWarning.notifyInChat","garden.visitor.rewardWarning.notifyInChat")
        event.move(4,"garden.visitorRewardWarning.showOverName","garden.visitor.rewardWarning.showOverName")
        event.move(4,"garden.visitorRewardWarning.preventRefusing","garden.visitor.rewardWarning.preventRefusing")
        event.move(4,"garden.visitorRewardWarning.bypassKey","garden.visitor.rewardWarning.bypassKey")
        event.move(4,"garden.visitorRewardWarning.drops","garden.visitor.rewardWarning.drops")
        event.move(4, "garden.visitorNotificationChat", "garden.visitor.notificationChat")
        event.move(4, "garden.visitorNotificationTitle", "garden.visitor.notificationTitle")
        event.move(4, "garden.visitorHighlightStatus", "garden.visitor.highlightStatus")
        event.move(4, "garden.visitorColoredName", "garden.visitor.coloredName")
        event.move(4,"garden.visitorHypixelArrivedMessage","garden.visitor.hypixelArrivedMessage")
        event.move(4, "garden.visitorHideChat", "garden.visitor.hideChat")
    }
