...
object PigFeaturesApi {
    ...
    /**
     * @regexTest SHINY! You extracted Shiny Shard and Blood God Crest from the piglet's orb!
     * @regexTest SHINY! You extracted Shiny Shard and +1,185,000 Coins from the piglet's orb!
     * @regexTest SHINY! You extracted Shiny Shard and +1,000 Foraging XP from the piglet's orb!
     * @regexTest SHINY! You extracted Shiny Shard and 16x Enchanted Potato from the piglet's orb!
     */
    ...
    fun onChat(event: SkyHanniChatEvent.Allow) {
        ...
        orbChargedChatPattern.matchMatcher(message) {
            ...
            ShinyOrbChargedEvent(orbEntity?.id).post()
        }
