...
object DraconicSacrificeTracker {
    ...
    private val config get() = HanniMod.feature.combat.endIsland.draconicSacrificeTracker
    ...
    private val tracker =
        HanniItemTracker("Draconic Sacrifice Profit Tracker", { Data() }, { it.draconicSacrificeTracker }) {
            drawDisplay(it)
        }
