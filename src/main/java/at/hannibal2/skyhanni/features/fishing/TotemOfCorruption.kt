...
import at.hannibal2.hanni.config.features.fishing.TotemOfCorruptionConfig.OutlineType
...
import at.hannibal2.hanni.utils.SoundUtils.playBeepSound
...
import at.hannibal2.hanni.utils.render.WorldRenderUtils.drawSphereInWorld
import at.hannibal2.hanni.utils.render.WorldRenderUtils.drawSphereWireframeInWorld
...
object TotemOfCorruption {
    ...
    private val config get() = HanniMod.feature.fishing.totemOfCorruption
