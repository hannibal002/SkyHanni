...
import at.hannibal2.skyhanni.features.fishing.seaCreatureXMLGui.SpecificSeaCreatures.Companion.saveSeaCreatures
...
object SeaCreatureManager {
    ...
    fun onRepoReload(event: RepositoryReloadEvent) {
        ...
        saveSeaCreatures(SpecificSeaCreatures.updateList())
    }
