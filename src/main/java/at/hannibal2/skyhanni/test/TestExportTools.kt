...
object TestExportTools {
    ...
    val gson = GsonBuilder()
        ...
        .registerTypeAdapter(ItemStack::class.java, LegacyItemStackTypeAdapter())
        .create()

    private class LegacyItemStackTypeAdapter : TypeAdapter<ItemStack>() {
        ...
        private fun buildFromLegacyNbt(tag: CompoundTag): ItemStack {
            ...
            val item = BuiltInRegistries.ITEM.getValue(Identifier.parse(rawId)) ?: Items.AIR
