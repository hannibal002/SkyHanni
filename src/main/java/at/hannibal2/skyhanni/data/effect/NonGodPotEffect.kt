...
enum class NonGodPotEffect(
    ...
    PEST_REPELLENT(
        ...
        effectGainedMessage = "YUM! ${SkyblockMobType.PEST} Pests will now spawn 2x less while you break crops for the next 60m!",
        effectDuration = 1.hours,
        effectChangeType = EffectDurationChangeType.SET,
    ),
    PEST_REPELLENT_MAX(
        ...
        effectGainedMessage = "YUM! ${SkyblockMobType.PEST} Pests will now spawn 4x less while you break crops for the next 60m!",
        effectDuration = 1.hours,
        effectChangeType = EffectDurationChangeType.SET,
    ),
