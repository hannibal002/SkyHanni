...
value class SkyblockIcon private constructor(private val icon: Char) {
    ...
    companion object {
        ...
        val WHEAT_FORTUNE = FARMING_FORTUNE
        val CARROT_FORTUNE = FARMING_FORTUNE
        val POTATO_FORTUNE = FARMING_FORTUNE
        val PUMPKIN_FORTUNE = FARMING_FORTUNE
        val SUGAR_CANE_FORTUNE = FARMING_FORTUNE
        val MELON_FORTUNE = FARMING_FORTUNE
        val CACTUS_FORTUNE = FARMING_FORTUNE
        val COCOA_BEANS_FORTUNE = FARMING_FORTUNE
        val MUSHROOM_FORTUNE = FARMING_FORTUNE
        val NETHER_STALK_FORTUNE = FARMING_FORTUNE
        val SUNFLOWER_FORTUNE = FARMING_FORTUNE
