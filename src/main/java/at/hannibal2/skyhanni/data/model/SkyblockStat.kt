...
enum class SkyblockStat(
    ...
    WHEAT_FORTUNE("§6☘", "", " *§6☘ Wheat Fortune $VALUE_PATTERN"),
    CARROT_FORTUNE("§6☘", "", " *§6☘ Carrot Fortune $VALUE_PATTERN"),
    POTATO_FORTUNE("§6☘", "", " *§6☘ Potato Fortune $VALUE_PATTERN"),
    PUMPKIN_FORTUNE("§6☘", "", " *§6☘ Pumpkin Fortune $VALUE_PATTERN"),
    MELON_FORTUNE("§6☘", "", " *§6☘ Melon Fortune $VALUE_PATTERN"),
    MUSHROOM_FORTUNE("§6☘", "", " *§6☘ Mushroom Fortune $VALUE_PATTERN"),
    CACTUS_FORTUNE("§6☘", "", " *§6☘ Cactus Fortune $VALUE_PATTERN"),
    NETHER_WART_FORTUNE("§6☘", "", " *§6☘ Nether Wart Fortune $VALUE_PATTERN"),
    COCOA_BEANS_FORTUNE("§6☘", "", " *§6☘ Cocoa Beans Fortune $VALUE_PATTERN"),
    SUGAR_CANE_FORTUNE("§6☘", "", " *§6☘ Sugar Cane Fortune $VALUE_PATTERN"),
