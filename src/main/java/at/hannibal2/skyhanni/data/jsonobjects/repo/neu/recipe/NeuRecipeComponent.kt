...
data class NeuRecipeComponent(val internalName: NeuInternalName? = null, val count: Int = 1) {
    ...
    fun toPrimitiveIngredientOrEmpty() = internalName?.let { PrimitiveIngredient(it, count) } ?: PrimitiveIngredient.EMPTY
