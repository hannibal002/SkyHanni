...
import at.hannibal2.skyhanni.config.features.misc.tracker.individual.PerTrackerConfig.TrackerSync.configSet
...
object TrackerManager {
    ...
    fun onConfigLoad(event: ConfigLoadEvent) {
        ...
        for (config in configSet) {
            ...
            if (config.trackerConfig is ItemTrackerSettings) {
