...
import at.hannibal2.skyhanni.mixins.hooks.ParticleSuppressionMarker;
import net.minecraft.network.protocol.game.ClientboundLevelParticlesPacket;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.Unique;

@Mixin(ClientboundLevelParticlesPacket.class)
public abstract class MixinClientboundLevelParticlesPacket implements ParticleSuppressionMarker {
    @Unique
