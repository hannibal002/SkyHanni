...
object MinecraftInputHook {
    ...
    fun shouldCancelContinuedBlockBreak(
        ...
        val clickCancelled = ItemClickEvent(InventoryUtils.getItemInHand(), WorldClickType.LEFT_CLICK).post()
