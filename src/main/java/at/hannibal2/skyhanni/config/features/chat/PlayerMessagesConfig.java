...
public class PlayerMessagesConfig {
    ...
    @Expose
    @ConfigOption(name = "Prefix Formatting", desc = "Change the text format in front of the player chat message.")
    @Accordion
    public PrefixFormattingConfig prefixFormatting = new PrefixFormattingConfig();
