...
public class CustomSpeedConfig {
    ...
    @Expose
    @ConfigOption(name = "Wheat", desc = "Suggested farming speed:\n" +
    ...
    @Expose
    @ConfigOption(name = "Carrot", desc = "Suggested farming speed:\n" +
        "§e5 Blocks§7: §f✦ 93 speed\n" +
        "§e4 Blocks§7: §f✦ 116 speed")
    @ConfigEditorSlider(minValue = 1, maxValue = 400, minStep = 1)
    ...
    @Expose
    @ConfigOption(name = "Potato", desc = "Suggested farming speed:\n" +
        "§e5 Blocks§7: §f✦ 93 speed\n" +
        "§e4 Blocks§7: §f✦ 116 speed")
    @ConfigEditorSlider(minValue = 1, maxValue = 400, minStep = 1)
    ...
    @Expose
    @ConfigOption(name = "Nether Wart", desc = "Suggested farming speed:\n" +
        "§e5 Blocks§7: §f✦ 93 speed\n" +
        "§e4 Blocks§7: §f✦ 116 speed")
    @ConfigEditorSlider(minValue = 1, maxValue = 400, minStep = 1)
    ...
    @Expose
    @ConfigOption(name = "Pumpkin", desc = "Suggested farming speed:\n" +
    ...
    @Expose
    @ConfigOption(name = "Melon", desc = "Suggested farming speed:\n" +
        "§e3 Blocks§7: §f✦ 155 speed\n" +
    ...
    @Expose
    @ConfigOption(name = "Cocoa Beans", desc = "Suggested farming speed:\n" +
        "§e3 Blocks§7: §f✦ 155 speed\n" +
        "§e4 Blocks§7: §f✦ 116 speed")
    @ConfigEditorSlider(minValue = 1, maxValue = 400, minStep = 1)
    ...
    @Expose
    @ConfigOption(name = "Sugar Cane", desc = "Suggested farming speed:\n" +
        "§eYaw 45§7: §f✦ 328 speed")
    @ConfigEditorSlider(minValue = 1, maxValue = 400, minStep = 1)
    public Property<Float> sugarCane = Property.of(328f);

    @Expose
    @ConfigOption(name = "Cactus", desc = "Suggested farming speed:\n" +
    ...
    // TODO does other speed settings exist?
    @Expose
    @ConfigOption(name = "Mushroom", desc = "Suggested farming speed:\n" +
