...
class DevConfig {
    ...
    @Expose
    val debugPos: Position = Position(10, 10, false, true)

    // Does not have a config element!
    @Expose
    val debugLocationPos: Position = Position(1, 160, false, true)
    ...
    val debugOrePos: Position = Position(1, 200, false, true)
