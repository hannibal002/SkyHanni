...
public class MiscConfig {
    ...
    @Expose
    public Position collectionCounterPos = new Position(10, 10, false);

    @Expose
    public Position carryPosition = new Position(10, 10, false);
    ...
    public Position playerMovementSpeedPos = new Position(394, 124, false);
    ...
    public Position inventoryLoadPos = new Position(394, 124, false);
