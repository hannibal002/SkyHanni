...
class SeeThroughWindowConfig {
    ...
    @Expose
    @ConfigOption(name = "See Through Farming", desc = "Makes the window transparent with a keybind so you can watch YouTube behind the game")
    @ConfigEditorSlider(minValue = 5f, maxValue = 100f, minStep = 1f)
    var seeThroughFarming: Property<Float> = Property.of(100f)
