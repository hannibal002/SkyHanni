...
class GreatSpookConfig {
    ...
    val positionTimer: Position = Position(20, 20, false, true)
    ...
    val positionFear: Position = Position(30, 30, false, true)
    ...
    val positionTimeLeft: Position = Position(40, 40, false, true)
