...
class CFConfig {
    ...
    var position: Position = Position(163, 160, false)
    ...
    var strayRabbitTrackerPosition: Position = Position(300, 300, false)
    ...
    var hitmanCostsPosition: Position = Position(300, 300, false)
