...
class CFConfig {
    ...
    val tooltipMovePosition: Position = Position(-380, 150, false, true)
    ...
    val strayRabbitTrackerPosition: Position = Position(300, 300, false, true)
    ...
    val hitmanCostsPosition: Position = Position(300, 300, false, true)
