...
public class SpacingConfig {
    ...
    @ConfigEditorSlider(minValue = 30, maxValue = 200, minStep = 1)
    ...
    @ConfigEditorSlider(minValue = 5, maxValue = 18, minStep = 1)
