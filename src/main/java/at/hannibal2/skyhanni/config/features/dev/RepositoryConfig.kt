...
class RepositoryConfig : AbstractRepoConfig<RepositoryConfig.RepositoryLocation>() {
    ...
    override val updateRepo: Runnable = Runnable { HanniRepoManager.updateRepo("config button") }
    ...
    class RepositoryLocation : AbstractRepoLocationConfig() {
        ...
        @Expose
        @ConfigOption(name = "Repository Name", desc = "The Repository Name, default: Hanni-REPO")
        @ConfigEditorText
        override var repoName: String = "Hanni-REPO"
        ...
        @Transient override val defaultRepoName = "Hanni-REPO"
