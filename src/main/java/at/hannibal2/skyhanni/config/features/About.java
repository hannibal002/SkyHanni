...
public class About {
    ...
    @ConfigOption(name = "Full Auto Updates", desc = "Automatically download the newest version upon startup.")
    @Expose
    @FeatureToggle
    @ConfigEditorBoolean
    public boolean fullAutoUpdates = false;

    @ConfigOption(name = "Update Stream", desc = "What type of mod releases you will receive.")
    @Expose
    @ConfigEditorDropdown
    public Property<UpdateStream> updateStream = Property.of(UpdateStream.RELEASES);


    @ConfigOption(name = "Used Software", desc = "Information about other software used by skyhanni and their licenses")
    @Accordion
    @Expose
    ...
    public static class Licenses {
        ...
        @ConfigEditorButton(buttonText = "Source")
        public Runnable discordRPC = () -> OSUtils.openBrowser("https://github.com/ThatGravyBoat/DiscordIPC");
    }
}
