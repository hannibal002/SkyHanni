...
class WormholeFinderConfig {
    ...
    @Expose
    @ConfigOption(name = "Show All Waypoints", desc = "Render a marker and label at every matched wormhole location, not just the active pathfind target.")
    @ConfigEditorBoolean
    var showAllWaypoints: Boolean = true
