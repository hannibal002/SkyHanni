...
class CrystalHighlighterColorConfig {
    ...
    @ConfigEditorColour
    val amber: Property<String> = Property.of("0:127:203:100:0")

    @Expose
    @ConfigOption(name = "Amethyst", desc = "§7Default: §#§a§8§0§b§c§b§/#A80BCB")
    @ConfigEditorColour
    val amethyst: Property<String> = Property.of("0:127:168:11:203")

    @Expose
    @ConfigOption(name = "Topaz", desc = "§7Default: §#§c§d§c§4§0§0§/#CDC400")
    @ConfigEditorColour
    val topaz: Property<String> = Property.of("0:127:205:196:0")

    @Expose
    @ConfigOption(name = "Jade", desc = "§7Default: §#§6§8§c§b§0§0§/#68CB00")
    @ConfigEditorColour
    val jade: Property<String> = Property.of("0:85:104:203:0")

    @Expose
    @ConfigOption(name = "Sapphire", desc = "§7Default: §#§2§9§6§4§c§b§/#2964CB")
    @ConfigEditorColour
    val sapphire: Property<String> = Property.of("0:127:41:100:203")
}
