...
public class MiscConfig {
    ...
    public static class QuickModMenuSwitch {
        ...
        @ConfigEditorBoolean
        public boolean showModsOutsideSB = false;
    ...
    public static class CosmeticConfig {
        ...
        public static class FollowingLineConfig {
            ...
            @Expose
            @ConfigOption(name = "Show Outside SB", desc = "Show line outside of SkyBlock.")
            @ConfigEditorBoolean
    ...
    public static class HighlightPartyMembers {
        ...
        @ConfigEditorBoolean
        public boolean highlightPartyOutsideSB = false;
    ...
    @Accordion
    public MovementSpeedConfig playerMovementSpeed = new MovementSpeedConfig();

    public static class MovementSpeedConfig {

        @Expose
        @ConfigOption(name = "Enabled", desc = "Show the player movement speed in blocks per second.")
        @ConfigEditorBoolean
        @FeatureToggle
        public boolean enabled = false;
