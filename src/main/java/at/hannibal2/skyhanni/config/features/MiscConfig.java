...
public class MiscConfig {
    ...
    public static class ChatSymbols {
        ...
        @Expose
        @ConfigOption(name = "Chat Symbol Location", desc = "Determines where the symbols should go in chat. " +
                "Hidden will hide all emblems from the chat. §eRequires above setting to be on for this")
