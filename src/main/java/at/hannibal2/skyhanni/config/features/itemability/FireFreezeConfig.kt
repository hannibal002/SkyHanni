...
class FireFreezeConfig {
    ...
    @Expose
    @ConfigOption(name = "Box Frozen Mobs", desc = "Draws a box around frozen mobs" +
    ...
    @Expose
    @ConfigOption(name = "Custom Circle", desc = "Replaces the particle-based circle by Hypixel with a custom Circle similar to fire freeze.")
    @ConfigEditorBoolean
    @FeatureToggle
    var customCircle: Boolean = false

    @Expose
    @ConfigOption(name = "Freeze Circle Colour", desc = "Changes the Colour of the Circular Line")
    @ConfigEditorColour
