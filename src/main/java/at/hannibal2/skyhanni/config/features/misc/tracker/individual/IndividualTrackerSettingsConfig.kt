...
class IndividualTrackerSettingsConfig(private val title: String, settings: TrackerGenericConfig) : Config() {
    ...
    @Expose
    @Category(name = "Tracker Settings", desc = "Settings that only apply to this tracker.")
    val settings: TrackerGenericConfig = settings
}
