...
class EndermanBeaconConfig {
    ...
    companion object {
        ...
        private fun onConfigFix(event: ConfigUpdaterMigrator.ConfigFixEvent) {
            ...
            event.move(147, "slayer.endermen.beacon.showLine", "slayer.endermen.beacon.line.showLine")
            event.move(147, "slayer.endermen.beacon.lineColor", "slayer.endermen.beacon.line.color")
            event.move(147, "slayer.endermen.beacon.lineWidth", "slayer.endermen.beacon.line.lineWidth")
        }
    }
}
