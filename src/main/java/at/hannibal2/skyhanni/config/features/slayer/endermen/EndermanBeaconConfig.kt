...
class EndermanBeaconConfig {
    ...
    companion object {
        ...
        fun onConfigFix(event: ConfigUpdaterMigrator.ConfigFixEvent) {
            ...
            event.move(130, "slayer.endermen.beacon.showLine", "slayer.endermen.beacon.line.showLine")
            event.move(130, "slayer.endermen.beacon.lineColor", "slayer.endermen.beacon.line.lineWidth")
            event.move(130, "slayer.endermen.beacon.lineWidth", "slayer.endermen.beacon.line.color")
        }
    }
}
