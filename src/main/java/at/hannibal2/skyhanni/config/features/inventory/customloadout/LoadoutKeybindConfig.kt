...
class LoadoutKeybindConfig {
    ...
    @ConfigOption(
        ...
        desc = "Enable/Disable the slot keybinds.\n§cThis only works inside the Custom Loadout GUI.",
    )
    @ConfigEditorBoolean
    @FeatureToggle
    ...
    @Expose
    @ConfigOption(name = "Slot 10", desc = "Keybind for slot 10")
    @ConfigEditorKeybind(defaultKey = GLFW.GLFW_KEY_UNKNOWN)
    var slot10: Int = GLFW.GLFW_KEY_UNKNOWN

    @Expose
    @ConfigOption(name = "Slot 11", desc = "Keybind for slot 11")
    @ConfigEditorKeybind(defaultKey = GLFW.GLFW_KEY_UNKNOWN)
    var slot11: Int = GLFW.GLFW_KEY_UNKNOWN

    @Expose
    @ConfigOption(name = "Slot 12", desc = "Keybind for slot 12")
    @ConfigEditorKeybind(defaultKey = GLFW.GLFW_KEY_UNKNOWN)
