...
public class NextConfig {
    ...
    @ConfigOption(
        name = "Always On",
        desc = "Always Show the Best Display while in the garden.")
    @ConfigEditorBoolean
    ...
    @ConfigOption(
        ...
        desc = "Compacts the best crop time: Removing the crop name and exp, hide the # number and using a more compact time format.")
    @ConfigEditorBoolean
