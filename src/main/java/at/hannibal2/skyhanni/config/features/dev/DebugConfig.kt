...
class DebugConfig {
    ...
    var copyInternalName = ConfigKeybind()
    ...
    @ConfigEditorKeyMapping
    var copyCosmeticsSkullData = ConfigKeybind()
    ...
    @ConfigEditorKeyMapping
    var bypassAdvancedPlayerTabList = ConfigKeybind()
