...
annotation class HandleEvent(
    ...
    enum class Priority {
        ...
        HIGH,
        NORMAL,
        UNSPECIFIED, // Private sentinel value, do not use outside this file
        LOW,
    ...
    companion object {
        ...
        val HandleEvent.effectivePriority: Priority
            get() = if (priority.isNotBlank()) {
                require(priorityLevel == UNSPECIFIED) {
                    "priorityLevel and priority cannot be specified at the same time"
                }
