...
/**
 * For detecting area changes in the scoreboard, which is less accurate than the graph.
...
/**
 * For detecting area changes in the graph, which is more accurate than the scoreboard.
 */
