...
import at.hannibal2.hanni.api.HotmApi.PowderType
import at.hannibal2.hanni.api.SkillApi
import at.hannibal2.hanni.data.IslandType
import at.hannibal2.hanni.data.MaxwellApi.ThaumaturgyPowerTuning
...
import at.hannibal2.hanni.features.combat.end.DragonProfitTracker
import at.hannibal2.hanni.features.combat.end.endernodetracker.EnderNodeTracker
import at.hannibal2.hanni.features.combat.ghosttracker.GhostTracker
import at.hannibal2.hanni.features.commands.OpenLastStorage
import at.hannibal2.hanni.features.dungeon.CroesusChestTracker.OpenedState
import at.hannibal2.hanni.features.dungeon.CroesusChestTracker.generateMaxChestAsList
import at.hannibal2.hanni.features.dungeon.DungeonFloor
import at.hannibal2.hanni.features.event.carnival.CarnivalGoal
import at.hannibal2.hanni.features.event.diana.DianaProfitTracker
import at.hannibal2.hanni.features.event.diana.MythologicalCreatureTracker
import at.hannibal2.hanni.features.event.hoppity.HoppityCollectionStats.LocationRabbit
import at.hannibal2.hanni.features.event.hoppity.HoppityEggType
import at.hannibal2.hanni.features.event.jerry.frozentreasure.FrozenTreasureTracker
import at.hannibal2.hanni.features.event.yearofthepig.ShinyOrbTracker
import at.hannibal2.hanni.features.fame.UpgradeReminder.CommunityShopUpgrade
import at.hannibal2.hanni.features.fishing.tracker.FishingProfitTracker
import at.hannibal2.hanni.features.fishing.tracker.SeaCreatureTracker
import at.hannibal2.hanni.features.fishing.trophy.TrophyRarity
import at.hannibal2.hanni.features.foraging.ForagingTrackerLegacy
import at.hannibal2.hanni.features.garden.CropAccessory
import at.hannibal2.hanni.features.garden.CropType
import at.hannibal2.hanni.features.garden.GardenPlotApi.PlotData
import at.hannibal2.hanni.features.garden.farming.ArmorDropTracker
import at.hannibal2.hanni.features.garden.farming.DicerRngDropTracker
...
import at.hannibal2.hanni.features.garden.pests.PestProfitTracker
import at.hannibal2.hanni.features.garden.pests.stereo.VinylType
import at.hannibal2.hanni.features.garden.visitor.VisitorReward
import at.hannibal2.hanni.features.gifting.GiftProfitTracker
import at.hannibal2.hanni.features.inventory.EquipmentApi
import at.hannibal2.hanni.features.inventory.chocolatefactory.stray.CFStrayTracker
import at.hannibal2.hanni.features.inventory.experimentationtable.ExperimentsProfitTracker
import at.hannibal2.hanni.features.inventory.wardrobe.WardrobeApi.WardrobeData
import at.hannibal2.hanni.features.mining.MineshaftPityDisplay.PityData
import at.hannibal2.hanni.features.mining.crystalhollows.CrystalNucleusTracker
import at.hannibal2.hanni.features.mining.fossilexcavator.ExcavatorProfitTracker
import at.hannibal2.hanni.features.mining.glacitemineshaft.CorpseTracker
import at.hannibal2.hanni.features.mining.glacitemineshaft.MineshaftDetection
import at.hannibal2.hanni.features.mining.powdertracker.PowderTracker
import at.hannibal2.hanni.features.misc.DraconicSacrificeTracker
import at.hannibal2.hanni.features.misc.EnchantedClockHelper
import at.hannibal2.hanni.features.misc.trevor.TrevorTracker.TrapperMobRarity
import at.hannibal2.hanni.features.nether.reputationhelper.FactionType
import at.hannibal2.hanni.features.rift.area.mountaintop.TimiteTracker
import at.hannibal2.hanni.features.rift.area.westvillage.VerminTracker
import at.hannibal2.hanni.features.rift.area.westvillage.kloon.KloonTerminal
import at.hannibal2.hanni.features.skillprogress.SkillType
import at.hannibal2.hanni.features.slayer.SlayerProfitTracker
...
class ProfileSpecificStorage(
    ...
    class GardenStorage {
        ...
        // Todo: Move to a HanniTracker (preferably bucketed by rarity)
