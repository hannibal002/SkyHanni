package at.hannibal2.hanni.features.combat.ghosttracker
...
import at.hannibal2.hanni.data.jsonobjects.repo.GhostDropsJson
...
object GhostTracker {
    ...
    private val config get() = HanniMod.feature.combat.ghostCounter
