...
import at.hannibal2.hanni.config.features.event.AnniversaryTeamFinderColorConfig
...
object Year400Features {
    private val config get() = HanniMod.feature.event.anniversaryCelebration400
