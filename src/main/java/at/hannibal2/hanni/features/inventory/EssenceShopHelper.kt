...
import at.hannibal2.hanni.data.jsonobjects.repo.neu.NeuEssenceShopJson
...
object EssenceShopHelper {
    ...
    private fun isEnabled() = SkyBlockUtils.inSkyBlock && HanniMod.feature.inventory.essenceShopHelper
}
