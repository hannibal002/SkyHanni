...
import at.hannibal2.hanni.data.jsonobjects.repo.ItemValueCalculationDataJson
...
import at.hannibal2.hanni.features.nether.kuudra.KuudraApi.kuudraTiers
import at.hannibal2.hanni.features.nether.kuudra.KuudraApi.removeKuudraTier
import at.hannibal2.hanni.test.command.ErrorManager
import at.hannibal2.hanni.utils.EssenceUtils
import at.hannibal2.hanni.utils.EssenceUtils.getEssencePrices
...
import at.hannibal2.hanni.utils.ItemUtils.isRune
...
import at.hannibal2.hanni.utils.NumberUtil.intPow
import at.hannibal2.hanni.utils.PrimitiveIngredient
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getAbilityScrolls
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getAppliedPocketSackInASack
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getArmorDye
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getBookwormBookCount
...
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getEnrichment
...
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getFreeWill
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getGemstones
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getHelmetSkin
...
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getManaDisintegrators
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getMithrilInfusion
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getPolarvoidBookCount
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getPowerScroll
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getReforgeModifier
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getRodParts
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getRune
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getSilexCount
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getStarCount
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getTransmissionTunerCount
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.getWetBookCount
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.hasArtOfPeace
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.hasArtOfWar
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.hasBookOfStats
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.hasDivanPowderCoating
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.hasEtherwarp
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.hasJalapenoBook
import at.hannibal2.hanni.utils.SkyBlockItemModifierUtils.hasWoodSingularity
        ...
        for ((rawName, rawLevel) in enchantments) {
            ...
            val isAlwaysActive = try {
                ...
                ErrorManager.logErrorWithData(
                    e, "Estimated Item value failed to properly show ${internalName.repoItemName}",
