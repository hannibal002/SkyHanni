...
import at.hannibal2.hanni.config.features.misc.frogmask.FrogMaskWarningConfig.WarningType
...
object FrogMaskFeatures {
    private val config get() = HanniMod.feature.misc.frogMaskFeatures
