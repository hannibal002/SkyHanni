...
dependencies {
    ...
    val reiApi = "me.shedaniel:RoughlyEnoughItems-api-fabric:$reiVersion"
    if (isDeobf) compileOnly(reiApi) { exclude(group = "net.fabricmc.fabric-api") }
    else modCompileOnly(reiApi) { exclude(group = "net.fabricmc.fabric-api") }
